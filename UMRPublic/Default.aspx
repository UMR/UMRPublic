<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Public.Master" CodeBehind="Default.aspx.cs" Inherits="UMRPublic.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td>
                <h1>Welcome to Universal Medical Record<sup>&reg</sup></h1>
            </td>
        </tr>
        <tr>
            <td>

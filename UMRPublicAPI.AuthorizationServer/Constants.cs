...
namespace UMRPublicAPI.AuthorizationServer
{
    public class Constants
    {
        ...
        //public const string AuthorizationServer = "http://www.universalmedicalrecord.com/UMRPublicAPIAuthorizationServer";
        //public const string AuthorizationServerPath = AuthorizationServer + "/UMRPublic";
        //public const string ResourceServerPath = "http://www.universalmedicalrecord.com/UMRPublicAPIResourceServer";
        //public static List<string> WebClientServerPaths = new List<string> { "http://www.universalmedicalrecord.com", "http://universalmedicalrecord.com", "http://localhost" };
        //public const bool IsProductionBuild = false;

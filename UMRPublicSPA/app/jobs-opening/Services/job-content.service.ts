...
export class JobContentService {
    ...
    postJobContent(body: Object): Observable<Response> {
    ...
    updateJobContent(body: Object): Observable<Response> {
    ...
    deleteJobContent(jobContentId: number): Observable<Response> {
    ...
    getAllJobsByUserId(): Observable<JobContent[]> {
